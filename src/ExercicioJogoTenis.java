...
public class ExercicioJogoTenis {
	...
	public static void desempate() {
		...
		while (desempateJogo1 != 2 || desempateJogo2 != 2) {
			...
			if (desempateJogo1 == 2) {
				...
				System.out.println("Jogador 1 set após empate no game");

			} else if (desempateJogo2 == 2) {

				System.out.println("Jogador 2 set após empate no game");
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite: 1 Inicio de Jogo\n 2 - Fim");
